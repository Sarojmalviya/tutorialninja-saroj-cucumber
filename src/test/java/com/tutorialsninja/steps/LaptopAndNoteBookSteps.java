...
public class LaptopAndNoteBookSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() throws InterruptedException {
        new CheckOutPage().enterFirstName("Saroj");
        new CheckOutPage().enterLastName("Malviya");
        new CheckOutPage().enterEmailId("saroj");
        new CheckOutPage().enterTelephone("07721541514");
        new CheckOutPage().enterAddressLine1("31 kenton");
        new CheckOutPage().enterCity("Harrow");
        new CheckOutPage().enterPostCode("ha03sx");
